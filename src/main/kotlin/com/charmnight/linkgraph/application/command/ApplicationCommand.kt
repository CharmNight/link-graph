 ...
 * 都被建模为该 sealed interface 的一个具体子类，并分派到对应的具名 handler bean。
 *
...
internal sealed interface ApplicationCommand<out R> {
    fun dispatchTo(handlers: ApplicationCommandHandlers): R
    ...
    data object PreviewCurrentEditorSubjectKind : ApplicationCommand<SubjectPreviewKind?> {
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.subject.handle(this)
    }
    ...
    data class RequestIndexedGraph(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.indexedGraph.handle(this)
    }
    ...
    data class LoadGraph(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.workspace.handle(this)
    }
    ...
    data class RequestSourceNavigation(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.sourceNavigation.handle(this)
    }
    ...
    data class RequestAssistantTask(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.assistant.handle(this)
    }
    ...
    data object RetryLastQaRequest : ApplicationCommand<Unit> {
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.review.handle(this)
    }
    ...
    data class ConfirmQaCandidateChange(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.draft.handle(this)
    }
    ...
    data object RequestCodeDrafts : ApplicationCommand<Unit> {
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.generation.handle(this)
    }
    ...
    data class PrepareDebugRequestedAnalysisDisplayMode(
        ...
        override fun dispatchTo(handlers: ApplicationCommandHandlers) = handlers.debug.handle(this)
    }
