...
import com.charmnight.linkgraph.agent.artifact.CodeDraftArtifact
...
import com.charmnight.linkgraph.agent.runtime.budgetExceededStepResult
import com.charmnight.linkgraph.agent.runtime.failureReasonBeforeNextFileRead
import com.charmnight.linkgraph.agent.runtime.failureReasonForBudget
...
internal class CodegenCapability(
    ...
    private fun readConfirmedIntent(
        ...
        val artifactRefs = result.payload["artifactRefs"] as? List<com.charmnight.linkgraph.agent.artifact.ArtifactRef> ?: emptyList()
        if (confirmedCount <= 0) {
    ...
    private fun attachPlanArtifactIfPresent(
        ...
        val existingArtifact = runtimeContext.artifactStore.byType(com.charmnight.linkgraph.agent.artifact.ArtifactType.PLAN)
