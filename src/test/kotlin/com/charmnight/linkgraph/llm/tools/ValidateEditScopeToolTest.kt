...
class ValidateEditScopeToolTest : BasePlatformTestCase() {
    ...
    fun testAcceptsProjectRelativeDraftWhenValidatedScopeUsesAbsoluteProjectPath() {
        val absolutePath = requireNotNull(project.basePath) + "/src/main/java/com/example/CommonController.java"
        val scope = EditScope(
            scopeId = "scope-upload",
            targetNodeId = "method:upload-file",
