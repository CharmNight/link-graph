...
class GraphEditorApplicationDraftWorkbenchTest : BasePlatformTestCase() {
    fun testConfirmQaCandidateChangeUpdatesExistingDecisionNodeInWorkingGraph() {
        ...
        val entry = project.graphEditorApplicationServiceForTest().commandDispatcher.dispatch(ApplicationCommand.ConfirmQaCandidateChange("change-delete-guard"))
    ...
    fun testConfirmQaCandidateChangeInsertsExplicitDecisionNodeInsteadOfRewritingExistingNode() {
        ...
        val entry = project.graphEditorApplicationServiceForTest().commandDispatcher.dispatch(ApplicationCommand.ConfirmQaCandidateChange("change-insert-file-exists-guard"))
    ...
    fun testConfirmQaCandidateChangeAdvancesDraftVersionAndPreservesDerivedArtifacts() {
        ...
        project.graphEditorApplicationServiceForTest().commandDispatcher.dispatch(ApplicationCommand.ConfirmQaCandidateChange("change-upload-condition"))
    ...
    fun testConfirmQaCandidateChangeRejectsWeakEvidenceSuggestions() {
        ...
        val entry = project.graphEditorApplicationServiceForTest().commandDispatcher.dispatch(ApplicationCommand.ConfirmQaCandidateChange("change-path-risk"))
    ...
    fun testConfirmQaCandidateChangeRebuildsFlowchartViewWithModifiedDecisionNode() {
        ...
        project.graphEditorApplicationServiceForTest().commandDispatcher.dispatch(ApplicationCommand.ConfirmQaCandidateChange("change-delete-guard"))
